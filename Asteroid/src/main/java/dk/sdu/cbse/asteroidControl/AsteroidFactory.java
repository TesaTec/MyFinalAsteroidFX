...
public class AsteroidFactory {
    ...
    public static Entity createAsteroid(float x, float y, int size, float rotation, float speed, int health, int pieces) {
        ...
        asteroid.addComponent(new SplitterComponent(pieces));
